...
f1 = open('C:\\Users\\tanus\\Desktop\\sem5\\BD\\BD project\\logcopy.txt','w')
f2 = open('C:\\Users\\tanus\\Desktop\\sem5\\BD\\BD project\\log_b1.txt','w')
f3 = open('C:\\Users\\tanus\\Desktop\\sem5\\BD\\BD project\\log_b2.txt','w')
    ...
    while True:
        ...
        if not message1:
            ...
            if not os.path.exists(dirr):
                ...
                temp.write(zz4)
                logging.info(zz4)
                shutil.copyfile("logs.txt","logcopy.txt")
